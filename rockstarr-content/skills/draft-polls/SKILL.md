...
char_budgets:
  ...
  # ... per poll
produced_by: "rockstarr-content/draft-polls@0.6.0"
...
- `rockstarr-infra:publish-log` — per-poll publish logging
  on LinkedIn.
- `repurpose` — different lane. Repurpose creates short-form
  derivatives FROM approved long-form pieces. Polls are
  original short-form, not derivatives.
